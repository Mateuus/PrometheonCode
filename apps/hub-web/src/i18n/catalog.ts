...
export const CATALOG = {
  ...
  'account.profileReadOnly': 'Editing the profile is not available from the Hub yet.',
  ...
  'account.changePasswordHint': 'Changing the password ends every open session.',
  'account.changePasswordViaEmail':
    'Password changes go through the recovery link, the same flow as forgetting it.',
  'account.newPassword': 'New password',
  'sessions.title': 'Sessions',
  'sessions.subtitle': 'The session this browser is using.',
  'sessions.current': 'This device',
  'sessions.identifier': 'Session ID',
  'sessions.accessExpiresAt': 'Access token expires at',
  'sessions.autoRenew': 'Renewed automatically',
  'sessions.listUnavailable': 'Listing every session is not available yet',
  'sessions.listUnavailableHint':
    'The Hub does not expose the other sessions of your account. Signing out everywhere still works.',
